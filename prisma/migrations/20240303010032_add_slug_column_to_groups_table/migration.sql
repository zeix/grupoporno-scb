...
INSERT INTO "new_tb_groups" ("bannerImage", "categoryId", "description", "id", "link", "stApproved", "title", "type", "userIdApproved", "userIdCreated") SELECT "bannerImage", "categoryId", "description", "id", "link", "stApproved", "title", "type", "userIdApproved", "userIdCreated" FROM "tb_groups";
