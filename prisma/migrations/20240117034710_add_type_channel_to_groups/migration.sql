...
INSERT INTO "new_tb_groups" ("bannerImage", "categoryId", "description", "id", "link", "stApproved", "title", "userIdApproved", "userIdCreated") SELECT "bannerImage", "categoryId", "description", "id", "link", "stApproved", "title", "userIdApproved", "userIdCreated" FROM "tb_groups";
